function processWithNewAIF(raid1path, seriesName, first_series, numSlices, scaleAIF, preBolusFlag, select_SG_framesFlag);
...
call_modifyParFile(raid1path, islice, iseries, isub_range, seriesNumAIF, sliceNumAIF, scaleAIF);
