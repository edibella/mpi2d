...
scan_name='CV_Radial7Off_triple1_5(';
MID=168;
viewFirstTime = 1;

% if doReconFlag==1
%     load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID168_CV_Radial7Off_triple1_5_FID1218_Kspace.mat'],'-mat');
% end
% % size(kSpace)
...
seriesnumEnd=33
% must also change filenames
scan_name='CV_Radial7Off_triple4.4ML('
MID=169

if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID169_CV_Radial7Off_triple4.4ML_FID1219_Kspace'],'-mat');
end
...
seriesnumEnd=36
% must also change filenames
scan_name='CV_Radial7Off_triple_adeno('
MID=170
if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID170_CV_Radial7Off_triple_adeno_FID1220_Kspace.mat'],'-mat');
end
...
seriesnumEnd=56
% must also change filenames
scan_name='CV_Radial7Off_triple_lexi('
MID=184
if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID184_CV_Radial7Off_triple_lexi_FID1234_Kspace.mat'],'-mat');
end
