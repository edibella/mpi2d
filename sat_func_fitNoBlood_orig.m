function [Fsum]=sat_func_fitNoBlood_orig(x,bldcurve, sat_bldcurve, tisscurve,delta_t,nRegs,fixedDelay, fixedVp)
%  matlab function to be called by fmincon
% this one has no estGlobalDelay - no constraints on time delay
...
% [est_curves, tmpbldcurve]=mpi_sat_fwdModel(bldcurve, sat_bldcurve, delta_t, kwi(i), PartCoeff(i), t_delay(i), est_fb(i), spillover(i));
