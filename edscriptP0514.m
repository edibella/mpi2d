...
% 
% if doReconFlag==1
%     load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID50_CV_Radial7Off_triple1_5_FID6022_Kspace.mat'],'-mat');
% end
% % size(kSpace)
...
% seriesnumEnd=21
% % must also change filenames
% scan_name='CV_Radial7Off_triple3.7('
% MID=52
% 
% if doReconFlag==1
%     load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID52_CV_Radial7Off_triple3.7_FID6024_Kspace'],'-mat');
% end
% 
% for seriesnum=seriesnumStart:seriesnumEnd
% 	slice=seriesnum-seriesnumStart+1
...
seriesnumEnd=27
% must also change filenames
scan_name='CV_Radial7Off_tripleAdeno5.6('
MID=54
if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID54_CV_Radial7Off_tripleAdeno5.6_FID6026_Kspace'],'-mat');
end
...
seriesnumEnd=44
% must also change filenames
scan_name='CV_Radial7Off_tripleLexi5.6('
MID=65
if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID65_CV_Radial7Off_tripleLexi5.6_FID6037_Kspace'],'-mat');
