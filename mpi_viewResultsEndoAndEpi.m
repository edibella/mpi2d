...
plotCprof(kwiEndo, studyNum, vectorDescriptor, studyDescriptor, lineType, colorVector)  % last parameter is optional
vectorDescriptor='Epicardial ';
figure(3)
plotCprof(kwiEpi, studyNum, vectorDescriptor, studyDescriptor, lineType, colorVector) 
