...
if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID180_CV_Radial7Off_triple1_5_FID5896_Kspace.mat'],'-mat');
end
% size(kSpace)
...
seriesnumEnd=21
% must also change filenames
scan_name='CV_Radial7Off_triple_3.2('
MID=182

if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID182_CV_Radial7Off_triple_3.2_FID5898_Kspace'],'-mat');
end
...
seriesnumEnd=33
% must also change filenames
scan_name='CV_Radial7Off_triple_Adeno4.8('
MID=190
if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID190_CV_Radial7Off_triple_Adeno4.8_FID5906_Kspace'],'-mat');
end
...
seriesnumEnd=39
% must also change filenames
scan_name='CV_Radial7Off_triple_lexi4.8('
MID=195
if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID195_CV_Radial7Off_triple_lexi4.8_FID5911_Kspace'],'-mat');
