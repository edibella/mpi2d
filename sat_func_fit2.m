function [Fsum]=sat_func_fit2(x,bldcurve, sat_bldcurve, tisscurve,delta_t,nRegs,fixedDelay, fixedVp, estGlobalDelay)
...
errsum = 0.0;
for i=1:nRegs
  [est_curves, tmpbldcurve]=mpi_sat_fwdModel2(bldcurve, sat_bldcurve, delta_t, kwi(i), kwo(i), t_delay(i), est_fb(i), spillover(i));
...
% weight by Gaussian centered at start of tissue uptake
