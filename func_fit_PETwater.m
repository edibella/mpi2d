function [Fsum]=func_fit_PETwater(x,bldcurve, sat_bldcurve, tisscurve,delta_t,nRegs,fixedDelay, fixedVp, estGlobalDelay)
...
for i=1:nRegs
  [est_curves, tmpbldcurve]=mpi_PET_fwdModel(bldcurve, sat_bldcurve, delta_t, kwi(i), kwo(i), t_delay(i), est_fb(i), spillover(i));
