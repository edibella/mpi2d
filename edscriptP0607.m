...
if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID351_CV_Radial7Off_flex_72rays1_5_FID84204_Kspace.mat'],'-mat');
end
% size(kSpace)
...
seriesnumEnd=28
% must also change filenames
scan_name='CV_Radial7Off_flex_72rays6.4('
MID=352

if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID352_CV_Radial7Off_flex_72rays6.4_FID84205_Kspace'],'-mat');
end
...
seriesnumEnd=31
% must also change filenames
scan_name='CV_Radial7Off_flex_72rays6.4ADENO('
MID=353
if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID353_CV_Radial7Off_flex_72rays6.4ADENO_FID84206_Kspace'],'-mat');
end
...
seriesnumEnd=79
% must also change filenames
scan_name='CV_Radial7Off_flex_72rays6.4LEXI('
MID=387
if doReconFlag==1
    load(['/v/raid1/jfluck/MRIdata/Cardiac/' scanner '/' Patient '/RawData/meas_MID387_CV_Radial7Off_flex_72rays6.4LEXI_FID84240_Kspace'],'-mat');
end
