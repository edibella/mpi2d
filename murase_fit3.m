function fitparams = murase_fit3(sliceNum,studyNum,outpath,filenamePart1,delta_t, numAzimuthalRegions, numRadialRegions, flagPixelwise, numSkip, curvesFromClusters)
...
% nonlcon=[];
%max_delay=69;
outfilename=strcat(outpath,'cinemri1.study',int2str(studyNum),'.slice',int2str(sliceNum),'.mat');
    load(outfilename,'cinemri1');
    max_delay=(size(cinemri1,3))-1
