function curves = ExtractCurve_STDs(cinemri1,blood,endo,epi,angle,numAzimuthalRegions,referenceFrame)
    ...
    for region=1:numAzimuthalRegions
        ...
        for t=1:st
            temp2 = cinemri1(:,:,t);
            curves(t,region) = std(temp2(regionalMask>0));
        end
    end
    ...
    for t=1:st
        ...
        stdInAIF(t) = std(temp(newLV>0));
    end
    curves = vertcat(stdInAIF,curves');
    ...
    title('Tissue+AIF curve std deviations');
